 ...
 */
final class Version20200507100045 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE data_actualitzacio data_actualitzacio DATETIME DEFAULT NULL, CHANGE tag_meta tag_meta LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE tag_web tag_web LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    }
